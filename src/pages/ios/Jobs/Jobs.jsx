...
// Realistic list of jobs matching Pakistani CA/ACCA landscape
const INITIAL_JOBS = [
  {
    id: 1,
...
export default function Jobs({
  ...
  const visibleJobTypes = mode === 'inductions' ? ['Articleship', 'Internship'] : ['Full Time', 'Contract'];
  ...
  const handleApplySubmit = (e) => {
    e.preventDefault();
    setApplyForm({ ...applyForm, submitted: true });
    setTimeout(() => {
      setSelectedJob(null);
      setApplyForm({
        name: 'Usman Ali',
      ...
      alert('Application submitted successfully! Recruiter will contact you via email.');
    }, 2000);
  };
